...
/*	$order_no = "24325353";
	...
	$status = "Booked";
	$boarding_address ="ksdfskldfsfd";
	$company_name = "dsfsdfsdfsdf";
	$contact_no ="342432332423";
	$total_fare = "323";
	$to_mail = "sushil.lintel@gmail.com";
...
<div style='width:595px;margin:0 auto;border:#dfdfdf solid 1px'>
  ...
  <div style='margin:15px;padding-bottom:15px;overflow:hidden;border-bottom:1px solid #ededed'>
    ...
    <div style='float:left;width:160px'>
      <div style='text-transform:uppercase;color:#b5b5b5;font:500 11px Arial,Helvetica,sans-serif;padding-bottom:5px'>PNR</div>
      <div style='text-transform:capitalize;color:#727272;font:400 13px Arial,Helvetica,sans-serif'>".$pnr_no."</div>
    </div>
  ...
  <div style='margin:15px;padding-bottom:15px;overflow:hidden'>
    ...
    <table width='100%' border='0' cellspacing='0' cellpadding='5'>
      <tbody><tr>
        <td width='325' style='text-transform:uppercase;color:#b5b5b5;font:500 11px Arial,Helvetica,sans-serif;padding-bottom:5px'>PASSENGER NAME</td>
        <td width='115' style='text-transform:uppercase;color:#b5b5b5;font:500 11px Arial,Helvetica,sans-serif;padding-bottom:5px'>GENDER</td>
        <td width='115' style='text-align:center;text-transform:uppercase;color:#b5b5b5;font:500 11px Arial,Helvetica,sans-serif;padding-bottom:5px'>SEAT</td>
     ...
     //	$p_seat = "2";
        ...
        <td style='text-transform:capitalize;color:#727272;font:400 13px/1 Arial,Helvetica,sans-serif'>".$p_name."</td>
         <td style='text-transform:capitalize;color:#727272;font:400 13px/1 Arial,Helvetica,sans-serif'>".$p_gender."</td>
        <td style='text-align:center;text-transform:capitalize;color:#727272;font:400 13px/1 Arial,Helvetica,sans-serif'>".$p_seat."</td>
