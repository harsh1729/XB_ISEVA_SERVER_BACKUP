...
<html>
	...
	<body>
		<div id="loading_container" style="height: 110%;width: 100%;background-color: rgba(9, 9, 9, 0.4);;z-index:500;position: fixed;top: -30px;display:none ;">
		<div class="container text-center"><img src="<?=base_url('docs/images/ajax-loader-blue.gif')?>" style="margin-top: 250px;margin-left: -100px;"></div></div>
