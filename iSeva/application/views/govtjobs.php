		...
		<div class="col-md-12">
			<div class="panel panel-success">
				<div class="panel-heading">
					Add New Govt Jobs<span class="glyphicon glyphicon-remove pull-right"></span>
				</div>
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="heading" id="heading" value="" placeholder="jobs heading" class="form-control" required="required">
							<textarea name="content" style="margin-top:20px" required="required" id="content" class="textAreaMultiligne form-control" 
          placeholder="content"
