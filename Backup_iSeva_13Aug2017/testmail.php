...
<div style='width:595px;margin:0 auto;border:#dfdfdf solid 1px'>
  <div style='background:#f5f5f5;height:45px;padding:25px 0 0 20px'>
    ...
    <div style='color:#727272;font:500 12px Arial,Helvetica,sans-serif;float:right;font-weight:bold;margin:5px 15px 0 0;width:150px;text-align:right'>ORDER NO. ".$order_no."</div>
  </div>
...
$mail->From = "test@xercesblue.website";
