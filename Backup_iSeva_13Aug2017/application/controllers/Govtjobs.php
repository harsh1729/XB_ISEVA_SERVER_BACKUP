...
class Govtjobs extends MY_Controller {
		...
		public function index(){
		   ...
		   // $headerData['city'] = $this->city_model->get();
		    $data['data'] = $this->load->view('govtjobs',$headerData,TRUE);
		    $data['js'] = $this->load->view('view-parts/govtjobs-view-js-files','',TRUE);
