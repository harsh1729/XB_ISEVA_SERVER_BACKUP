	...
	function get()
	{
       ...
       function updateuser(){
			...
			else if($is_logged_in)
			{
				...
				$firmname = $this->input->get_post('fname');
				...
				echo json_encode(array("status"=>"login","data"=>$this->user_model->updateuserbyadmin($userid,$catid,$firmname,$firmcontact,$address,$cityid,$ismerchant,$services,$email)));
			}
       }
